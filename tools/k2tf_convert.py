'''
This code converts a .h5 Keras model into a Tensorflow .pb file which can be deployed to systems developed in C/C++.

Example Usage:
python tools/k2tf_convert.py --model "train/models/weights.best.hdf5" --numout 2 --outdir "train/models/"
